...
public interface RouteRepository extends JpaRepository<Route, Integer> {
	...
	//public Collection<Route> searchRoutes(Date departureDate, String origin, String destination, VehicleType vehicleType, Integer avaiableSeats, LuggageSize maxLuggage, Boolean pets, Boolean childs, Boolean smoke, Boolean music);
